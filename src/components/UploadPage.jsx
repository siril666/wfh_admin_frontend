  ...
  const handleFileChange = (e) => {
    ...
    reader.onload = (evt) => {
      ...
      const mappedData = jsonData.map((row) => ({
        ...
        Team: row["Team"] || null,
        TeamOwner: row["Team Owner"] || null,
        TeamOwnerID: row["Team Owner ID"] || 0,
        DM: row["DM"] || "",
        DM_ID: row["DM ID"] || 0,
      ...
      setData(mappedData.filter(item => item.ibsEmpId !== 0)); // Filter out invalid rows
  ...
  const handleUpload = async () => {
    ...
    try {
      const response = await axios.post(
        "http://localhost:8083/api/employees/upload", 
        data,
        {
          headers: { 
...
//     formData.append("file", file); // Use the original file, not parsed data
  
//     try {
//       await axios.post("http://localhost:8083/api/employees/upload", formData, {
//         headers: {
...
//                     <tr>
//                       <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Expedia FG Name</th>
//                       <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">ibsEmpId</th>
...
//                       <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">SVP Org</th>
//                       <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">VP Org</th>
//                       <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Director Org</th>
//                       <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Team</th>
//                       <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Team Owner</th>
//                       <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Team Owner ID</th>
//                       <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">DM</th>
//                       <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">DM ID</th>
